...
func main() {
	...
	protected.Use(middleware.AuthRequired())
	{
		...
		protected.POST("/subscriptions/:id/rules", subRuleHandler.Create)
		protected.GET("/subscriptions/:id/rules/:rule_id", subRuleHandler.Get)
		protected.PUT("/subscriptions/:id/rules/:rule_id", subRuleHandler.Update)
		protected.DELETE("/subscriptions/:id/rules/:rule_id", subRuleHandler.Delete)
		subScriptHandler := handler.NewSubScriptHandler()
		protected.GET("/subscriptions/:id/scripts", subScriptHandler.List)
		protected.POST("/subscriptions/:id/scripts", subScriptHandler.Create)
		protected.GET("/subscriptions/:id/scripts/:script_id", subScriptHandler.Get)
		protected.PUT("/subscriptions/:id/scripts/:script_id", subScriptHandler.Update)
		protected.DELETE("/subscriptions/:id/scripts/:script_id", subScriptHandler.Delete)
		protected.POST("/subscriptions/:id/scripts/:script_id/test", subScriptHandler.Test)
